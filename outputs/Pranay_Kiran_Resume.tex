...
\fancyfoot[C]{\footnotesize\textit{\color{muted}Build: 2025-09-28 21:06 IST \,\,|\,\, hash: fc7cbba658}}
...
\section*{Projects}
\ProjectEntry{Assembly Guidance System \& Robotic Arm Automation}{IoT guidance LEDs for operators, scaled to a robotic arm with AI-assisted sequencing.}{ESP32, Custom PCB, Firmware, Robotics}
\begin{itemize}
...
\ProjectEntry{Lithium Plant Establishment}{End-to-end lithium line setup: gloveboxes, argon dryer towers, process automation.}{}
\begin{itemize}
  \item Built in-house lithium capability
  \item Improved safety and reliability
\end{itemize}

\ProjectEntry{Full-Stack Banking Application}{Startup project: built and maintained full banking platform with DevOps automation.}{}
\begin{itemize}
...
\ProjectEntry{Hydrogen Fuel Cell Prototype}{Academic project on automotive fuel cell stack design and integration.}{}
